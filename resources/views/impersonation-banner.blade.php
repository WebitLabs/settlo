...
<div
    role="alert"
    style="position: sticky; top: 0; z-index: 40; display: flex; align-items: center; justify-content: center; gap: 0.75rem; padding: 0.5rem 1rem; background-color: #F59E0B; color: #1F1300; font-size: 0.875rem; font-weight: 600; box-shadow: 0 1px 4px rgba(0, 0, 0, 0.15);"
>
    <span>
