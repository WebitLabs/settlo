<x-filament-panels::page>
    ...
    @if ($this->ownerHasSeveralSoleProprietorships())
        <div class="flex items-start gap-2 rounded-xl bg-info-50 px-4 py-3 text-sm text-info-700 ring-1 ring-info-600/10 dark:bg-info-400/10 dark:text-info-300 dark:ring-info-400/20">
            ...
            <span>
                VAT registration for sole proprietorships is per person: all of your sole proprietorships share one VAT number,
                and their combined revenue counts towards the CHF 100'000 threshold.
            </span>
        </div>
    @endif
