...
<!-- For checkpoint task examples and patterns, see @/Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
