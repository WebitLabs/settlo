...
- Usage: Reference from command with `@/Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/grebe/projects/webit/php/laravel-claude-code-template/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
